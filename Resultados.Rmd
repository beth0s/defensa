...
setwd("D:/Tesis2020/Investigacion")
...
```{r}
# El mejor modelo propuesto por auto-arima de la serie hora es ARIMA(0,1,1)(0,1,0)[12]; es el primer modelo que nos servivara para calibrar.
```
...
# el mejor modelo generado por AUTO - ARIMA es un ARIMA(0,0,1)(0,1,0)[12]; de la serie con una diferencia.
...
```{r}
# Para encontrar el mejor modelo, calibraremos los modelos propuesto por Auto-arima y los mediremos con el Error Cuadr?tico Medio (ECM); y elegimos al modelo que tenga el menor ECM.
```
...
# ARIMA (2,0,0) (1,1,1) [12]; el cual obtuvo el menor ECM de 15.2407393959267.
```
...
```{r}
# El grafico de radar se observa que el modelo de Auto-arima y el modelo Calibrado tienen mediciones similares, a ecepcion de PTFA lo cual para elegir el menor modelo elegimos el menor PTFA que pertenece al modelo Calibrado de ARIMA (2, 1, 0) (1, 1, 1) (12.
```
...
### REALIZAMOS LA PREDICCION PARA LOS SIGUIENTES 12 MESES DEL 2020 CON SU RESPECTIVA GRAFICA CON EL MODELO ARIMA(2,1,0)(1,1,1)[12]

```{r, fig.align='center'}
#   PREDICCION
#  Analis con los 10 year y prediccion con el modelo ARIMA(3,2,0)(1,1,1)[12]
